/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: c8d9665f9122348f8c7e5d9e35dfc462)
...
declare namespace Cloudflare {
	...
	interface Env {
		EMAIL: SendEmail;
		AI: Ai;
		ALLOWED_EMAILS_DOMAINS: "hotmail.com,gmail.com,protonmail.com,proton.me";
		DISCORD_WEBHOOK_URL: "https://discord.com/api/webhooks/1501262928660402236/b_lsoi79DhazvyMUlM3-u8KD6QFrc3wq0jz7WGjhRJv3CPMQwyUqNAUMclX4uqWIvR65";
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ALLOWED_EMAILS_DOMAINS" | "DISCORD_WEBHOOK_URL">> {}
}
declare module "*.html" {
	const value: string;
